		...
		<Layout style={styles.full}>
			<ListItem style={styles.list} onPress={onNavigation}>
				<View style={styles.listbox}>
					<Text style={styles.key}>{shopInfo.shopName}</Text>
				</View>
			</ListItem>

			<ListItem style={styles.list} onPress={onNavigation}>
				<View style={styles.listbox}>
					<Text style={styles.key}>{shopInfo.address}</Text>
				</View>
			</ListItem>

			<ListItem style={styles.list} onPress={onNavigation}>
				<View style={styles.listbox}>
					<Text style={styles.key}>{shopInfo.phone}</Text>
				</View>
			</ListItem>

			<ListItem style={styles.list} onPress={onNavigation}>
				<View style={styles.listbox}>
					<Text style={styles.key}>{shopInfo.email}</Text>
				</View>
			</ListItem>
